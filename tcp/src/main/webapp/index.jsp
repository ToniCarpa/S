...
<nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="index.jsp">WIAM BLOG</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="jsp/register.jsp">Registrate</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="site-heading">
                    <h1>Log In</h1>
                    <span class="subheading">Entra en la Comunidad: <br> Postea, Comparte y Disfruta</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row gx-4 gx-lg-5 justify-content-center">
        ...
        <div>
            <form action="register.do" method="post">
                <div class="container position-relative px-4 px-lg-5">
                    <div class="row gx-4 gx-lg-5 justify-content-center">
                        <button class="nav-link px-lg-3 py-3 py-lg-4" type="submit">Registrate</button>
                    </div>
                </div>
            </form>
        </div>
